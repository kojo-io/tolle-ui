...
@Component({
    ...
    template: `
    <app-doc-hero slug="button" description="Displays a button or a component that looks like a button." id="overview" />
...
export class ButtonOverviewComponent {
    installationCode = `import { ButtonComponent } from '@tolle_/tolle-ui';
