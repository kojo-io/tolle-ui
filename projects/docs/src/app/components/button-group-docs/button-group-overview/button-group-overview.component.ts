...
@Component({
    ...
    template: `
    <app-doc-hero slug="button-group" description="Groups a series of buttons together on a single line." id="overview" />
...
export class ButtonGroupOverviewComponent {
    installationCode = `import { ButtonGroupComponent, ButtonComponent } from '@tolle_/tolle-ui';
