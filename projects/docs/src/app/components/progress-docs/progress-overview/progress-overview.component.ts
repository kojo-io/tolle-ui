...
@Component({
    ...
    template: `
    <app-doc-hero slug="progress" description="Displays an indicator showing the completion progress of a task." id="overview" />
...
export class ProgressOverviewComponent {
    installationCode = `import { ProgressComponent } from '@tolle_/tolle-ui';
