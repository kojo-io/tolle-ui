...
@Component({
    ...
    template: `
    <app-doc-hero slug="label" description="Renders an accessible label associated with a form control." id="overview" />
...
export class LabelOverviewComponent {
    installationCode = `import { LabelComponent } from '@tolle_/tolle-ui';
